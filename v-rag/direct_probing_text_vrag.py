...
def main_directprobing():
    ...
    for patient in tqdm(struct): 
                    ...
                    for entity, ent_type in zip(ents, ent_types):
                        ...
                        if top_k > 0:
                            ...
                            for sim_img in top_k_similar_images:
                                ...
                                img_count += 1
                                question += ' This is the {} medical report from the similar image for your reference. Report: '.format(str(img_count)) + sim_report
                        ...
                        question = [question] + [myprompt + " According to the given image and the reference report, does the patient have " + problem + "? "]
        ...
        if save_count > 0 and save_count % 50 == 0:       
            ...
            with open(output_path + 'test-ncbi' + '-radfm_prob_vRAG_top' + str(top_k) + '_usereport', "w") as outfile: 
